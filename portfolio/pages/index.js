...
export async function getStaticProps() {
    ...
    const categoryResponse = await fetch("https://bluekeyboardsoftware.com/raktim/api/category")
    const categories = await categoryResponse.json()    
    
    const skillResponse = await fetch("https://bluekeyboardsoftware.com/raktim/api/skill")
    const skills = await skillResponse.json()

    const portfolioResponse = await fetch("https://bluekeyboardsoftware.com/raktim/api/portfolio")
