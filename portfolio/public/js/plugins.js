        ...
        proto: {
            ...
            _preloadItem: function (n) {
                if (n = K(n), !t.items[n].preloaded) {
                    var i = t.items[n];
                    i.parsed || (i = t.parseEl(n)), k("LazyLoad", i), "image" === i.type && (i.img = e('<img className="mfp-img" />').on("load.mfploader", function () {
                        i.hasSize = !0
    ...
    return t.fn.tilt = function (i) {
        var s = function () {
            ...
            c = function () {
                ...
                if (i || t(this).append('<div className="js-tilt-glare"><div className="js-tilt-glare-inner"></div></div>'), this.glareElementWrapper = t(this).find(".js-tilt-glare"), this.glareElement = t(this).find(".js-tilt-glare-inner"), !i) {
                    var s = {
                        position: "absolute",
                        top: "0",
                        left: "0",
