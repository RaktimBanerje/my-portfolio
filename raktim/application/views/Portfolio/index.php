                    ...
                    <div class="row justify-content-start">
                        <?php foreach($portfolios as $portfolio) { ?>
                            <div class="col-md-3 card m-3" style="width:400px">
                                <div class="card">
                                    <img class="card-img-top" src="<?php echo $portfolio->image ?>" alt="" style="width: 370px; height: 380px;">
                                    <div class="card-body">
                                        <h4 class="card-title"><?php echo $portfolio->title ?></h4>
                                        <p class="card-text"><?php echo $portfolio->description ?></p>
                                        <p class="card-text"><?php echo $portfolio->link ?></p>
                                        <button 
                                            data-toggle="modal" 
                                            data-target="#myModal" 
                                            data-id="<?php echo $portfolio->id ?>" 
                                            data-image="<?php echo $portfolio->image ?>" 
                                            data-link="<?php echo $portfolio->link ?>" 
